...
@pytest.mark.django_db
def test_response_to_update_order(
    emulate_order_data, post_order_id=1, status="responsed"
):
...
@pytest.mark.django_db
def test_response_to_update_shipping(
    emulate_shipping_data, post_ship_id=1, status="responsed"
):
